    ...
    <div className="activity-chart">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={activityData?.sessions} barGap={8}>
          ...
          <Bar yAxisId="right" dataKey="kilogram" fill="#E60000" barSize={7} radius={[20, 20, 0, 0]} name="Poids (kg)" />
          <Bar yAxisId="left" dataKey="calories" fill="#282D30" barSize={7} radius={[20, 20, 0, 0]} name="Calories brûlées (kCal)" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
